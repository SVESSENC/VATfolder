...
- [ADR-005: Node.js + NestJS over Python + FastAPI (Current Phase)](./ADR-005-node-nestjs-over-python-fastapi.md)
 ...
 - [ADR-007: API Versioning Strategy](./ADR-007-api-versioning.md)
 - [ADR-008: Auth-By-Default Policy](./ADR-008-auth-by-default.md)
 - [ADR-009: Idempotency Standard](./ADR-009-idempotency.md)
 - [ADR-010: Canonical Tech Stack Lock](./ADR-010-canonical-stack.md)
- [ADR-011: Full Containerization with Open-Source Infrastructure](./ADR-011-containerization.md)
